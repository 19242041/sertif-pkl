...
Route::middleware('guest')->group(function () {
    ...
    Route::post('forgot-password/resend', [ForgotPasswordController::class, 'sendCode'])
        ->name('password.email.resend');

    Route::get('forgot-password/verify-code', [ForgotPasswordController::class, 'verify'])
    ...
    Route::get('forgot-password/reset-password', [ForgotPasswordController::class, 'reset'])
