                ...
                <div className="grid w-full items-center gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10">
                    <div className="hidden max-w-[640px] text-white lg:block">
                        ...
                        <h1 className="font-display max-w-[560px] text-[32px] font-extrabold leading-[1.15] text-white">
                            Buat password baru untuk akun SIMPATIK Anda.
                        </h1>
                        <p className="mt-4 max-w-[520px] text-[14.5px] leading-6 text-white/72">
                            Email <span className="font-semibold text-white">{email || '-'}</span> sudah diverifikasi. Sekarang tentukan password baru untuk masuk kembali.
                        </p>
                    </div>
                    ...
                    <div className="mx-auto w-full max-w-[400px] rounded-[24px] border border-white/55 bg-white/96 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.24)] backdrop-blur-xl">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="mt-1.5 max-w-xs text-[13px] leading-5 text-[#657085]">
                                Password akan menggantikan password lama untuk akun admin SIMPATIK.
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="mt-6">
                            ...
                            <div>
                                <label htmlFor="password" className="mb-1.5 block text-[12px] font-bold uppercase tracking-[0.08em] text-[#1B2733]">
                                    Password Baru
                                </label>
                                <input
                                    id="password"
                                ...
                                <div className="h-6 pt-1">
                                    {errors.password && <p className="text-[12px] font-medium text-[#C0433D]">{errors.password}</p>}
                                </div>
                            </div>

                            <div>
                                <label htmlFor="password_confirmation" className="mb-1.5 block text-[12px] font-bold uppercase tracking-[0.08em] text-[#1B2733]">
                                    Konfirmasi Password
                                </label>
                                <input
                                ...
                                />
                                <div className="h-6 pt-1">
                                    {errors.password_confirmation && <p className="text-[12px] font-medium text-[#C0433D]">{errors.password_confirmation}</p>}
                                </div>
                            </div>

                            {errors.email && <p className="mt-1 text-[12px] font-medium text-[#C0433D]">{errors.email}</p>}
                            ...
                            <Link href={route('password.request')} className="mt-5 block text-center text-[12px] font-semibold text-[#1B63B0] hover:underline">
                                Kirim kode lagi
                            </Link>
                        </form>
                    </div>
